...
export const DAYS: Record<number, DayDef> = {
  ...
  3: {
    ...
    ruleIds: R_SEGRETO,
    caseIds: ["a3_pratica_incompleta", "t3_visto_stampa", "a3_tessera_doppia"],
    events: [],
    quota: 3,
    payPerCase: 26000,
  },
  4: {
    ...
    ruleIds: R_FOTO,
    caseIds: ["a4_doppia_identita", "t4_pensionato"],
    events: [],
    quota: 2,
    payPerCase: 27000,
  },
  5: {
    ...
    ruleIds: R_ALL,
    caseIds: ["a5_nulla_osta_anello", "t5_velina"],
    events: [],
    quota: 2,
    payPerCase: 28000,
  },
  6: {
    ...
    ruleIds: R_ALL,
    caseIds: ["a6_fascicolo_cardo2", "t6_intercettazione"],
